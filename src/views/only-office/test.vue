...
<script>
import onlyOfficePreview from '@/views/only-office/preview.vue'
...
export default {
    ...
    methods: {
        ...
        previewPdf() {
            ...
            this.option.url = 'http://43.138.121.194:8889/onlyoffice_file/test1.pdf'
        ...
        previewExcel() {
            ...
            this.option.isEdit = false
            this.option.lang = 'zh-CN'
            this.option.url = 'http://43.138.121.194:8889/onlyoffice_file/test.xlsx'
