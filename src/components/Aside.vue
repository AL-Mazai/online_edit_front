...
<template>
    ...
    <el-menu :default-openeds="['1','2']" style="min-height: 100%; overflow-x: hidden"
        ...
        <el-submenu index="1">
            ...
            <!--我创建的-->
            <el-menu-item index="/create_doc">
                <i class="el-icon-circle-plus-outline"></i>
                <span slot="title">我创建的</span>
            </el-menu-item>
            <!--我参与的-->
            <el-menu-item index="/participate_doc">
        ...
        <el-submenu index="2">
            ...
            <!--我创建的-->
            <el-menu-item index="/create_team">
                <i class="el-icon-circle-plus-outline"></i>
                <span slot="title">我创建的</span>
            </el-menu-item>
            <!--我参与的-->
            <el-menu-item index="/participate_team">
                <i class="el-icon-plus"></i>
                <span slot="title">我参与的</span>
            </el-menu-item>
        </el-submenu>
        <!--导航栏三：回收站-->
        <el-menu-item index="/recycle_station">
